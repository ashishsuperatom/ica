...
assert.ok([...Object.keys({'resolve-terms':1,'overview':1,'find-measure':1,'describe':1,'group-paths':1,'find-dimension':1,'find-record':1,'check-question':1,'try-question':1,'run-program':1,'source-records':1,'trace-answer':1}), 'escalate'].every((t) => tools.includes(t)))
