...
export function createSession(harness: Harness, opts: SessionOpts): Session {
  switch (harness) {
    ...
    case 'pi':          return createPiSession({ cwd: opts.cwd, provider: opts.provider, model: opts.model, systemReference: opts.systemReference, noTools: opts.noTools, system: opts.system })
